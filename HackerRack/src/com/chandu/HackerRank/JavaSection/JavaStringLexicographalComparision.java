...
public class JavaStringLexicographalComparision {
	...
	public static void main(String args[]) {
		String string1 = new String("Geeks");///5
		String string2 = new String("Practice");//8
		String string3 = new String("Geeks");//5
		String string4 = new String("Geeksforgeeks");//13
